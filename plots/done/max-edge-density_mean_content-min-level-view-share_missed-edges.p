...
set output "max-edge-density_mean_content-min-level-view-share_missed-edges.eps"
...
splot "gnuplot/max-edge-density_mean_content-min-level-view-share.txt" using 2:3:6 with pm3d
