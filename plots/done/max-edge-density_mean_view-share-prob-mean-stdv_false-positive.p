...
set output "max-edge-density_mean_view-share-prob-mean-stdv_false-positive.eps"
...
splot "gnuplot/max-edge-density_mean_view-share-prob-mean-stdv.txt" using 2:3:5 with pm3d
